twt.exe: bin/Main.o bin/Utility.o bin/Network.o bin/Common.o bin/Thread.o bin/NetworkUtils.o
	g++ bin/Main.o bin/Utility.o bin/Network.o bin/Common.o bin/Thread.o bin/NetworkUtils.o -I /include/SDL2 -L /lib -lmingw32 -lSDL2main -lSDL2 -lws2_32 -lwsock32 -D_WIN32_WINNT=0x0601 -o twt.exe
