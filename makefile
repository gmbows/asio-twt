twt.exe: bin/Main.o bin/Utility.o bin/Network.o bin/Common.o bin/Thread.o
	g++ bin/Main.o bin/Utility.o bin/Network.o bin/Common.o bin/Thread.o -lws2_32 -lwsock32 -D_WIN32_WINNT=0x0601 -o twt.exe
